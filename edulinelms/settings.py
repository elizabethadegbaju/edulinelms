"""
Django settings for edulinelms project.
...
SECRET_KEY = '%no&g)e+#s+4+$xl($7ousb)^z!)gxot-27lt(22l%)3w1*vg%'
...
WSGI_APPLICATION = 'edulinelms.wsgi.application'
